...
const form = useForm({
    ...
    quiz_id: props.lesson.quiz_id || null,
    video: null,
...
const handleVideoUpload = (event) => {
    ...
    form.video = file;
    form.should_delete_video = false;
...
const removeVideo = () => {
    form.video = null;
    form.should_delete_video = true;
};

const submit = () => {
    form.post(route('teacher.courses.lessons.update', [props.course.id, props.lesson.id]), {
        forceFormData: true,
        onProgress: (event) => {
...
<template>
    <TeacherLayout title="ویرایش درس">
                        ...
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <!-- نمایش ویدیوی فعلی -->
                                    <div v-if="lesson.video_url && !form.should_delete_video && !form.video" class="mb-4">
                            ...
                            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                                ...
                                >
                                    ...
                                    <span>{{ form.processing ? 'در حال ذخیره...' : 'ذخیره تغییرات' }}</span>
                                </button>
                            </div>
                        </form>
                    </div>
