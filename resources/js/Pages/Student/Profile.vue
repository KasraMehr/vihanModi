  ...
  <StudentLayout title="Dashboard">
    <div class="bg-gray-50 dark:bg-gray-800 min-h-screen p-6">
        ...
        <div class="backdrop-blur-lg bg-gray-200 dark:bg-gray-900/80 rounded-2xl shadow-xl p-6 mb-8 border border-gray-400/20 dark:border-gray-700">
          <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="relative">
              ...
              <button v-if="isEditing" @click="editAvatar" class="absolute bottom-2 right-2 bg-purple-500 text-white p-2 rounded-full shadow-md hover:bg-purple-600 transition">
            ...
            <div class="backdrop-blur-lg bg-gray-200 dark:bg-gray-900/80 rounded-2xl shadow-xl p-6 border border-gray-400/20 dark:border-gray-700">
              ...
              <div v-for="progress in progressData" :key="progress.language_id" class="mb-6">
                <div class="flex justify-between items-center mb-2">
                  ...
                  <span class="text-sm font-medium text-purple-500">سطح {{ progress.level }}</span>
                </div>

                <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-4">
                  <div class="bg-purple-500 h-4 rounded-full" :style="`width: ${(progress.xp % 1000) / 10}%`"></div>
                </div>
                ...
                <div class="backdrop-blur-lg bg-gray-200 dark:bg-gray-900/80 rounded-2xl shadow-xl p-6 border border-gray-400/20 dark:border-gray-700">
                    ...
                    <div class="space-y-4">
                            ...
                            <div v-else>
                                <p v-if="studentProfile.learning_languages && studentProfile.learning_languages.length" class="text-gray-700 dark:text-gray-200">
                                    <span v-for="(lang, index) in studentProfile.learning_languages" :key="index"
                                          class="inline-block bg-purple-100 dark:bg-purple-800/70 text-purple-800 dark:text-purple-100 px-2 py-1 rounded-full text-sm mr-1 mb-1">
                                      {{ lang }}
                                    </span>
                                </p>
                        ...
                        <div>
                            ...
                            <select v-if="isEditing" v-model="form.preferpurple_learning_style"
                            ...
                            <p v-else class="text-gray-700 dark:text-gray-200">
                                {{ studentProfile.preferpurple_learning_style || 'ثبت نشده' }}
                            </p>
                        </div>
      ...
      <div class="flex justify-start mt-8">
        <button v-if="!isEditing" @click="startEditing" class="flex items-center gap-2 bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg transition">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
          </svg>
          ویرایش پروفایل
  ...
  data() {
    return {
      ...
      form: {
        ...
        preferpurple_learning_style: this.studentProfile.preferpurple_learning_style,
...
.multiselect-tag-remove {
  @apply text-purple-800 dark:text-purple-200 hover:bg-purple-200 dark:hover:bg-purple-800;
}

/* استایل‌های فرم */
input, textarea, select {
  @apply focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:focus:ring-purple-600 dark:focus:border-purple-600;
}
</style>
