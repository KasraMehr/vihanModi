<template>
    <StudentLayout title="Dashboard">
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-r from-purple-500 to-blue-600 rounded-2xl p-6 shadow-lg text-white">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
                <div class="border-b border-gray-100 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
                    ...
                    <Link href="/student/courses" class="text-sm text-purple-600 dark:text-purple-400 hover:underline">
                        مشاهده همه
                    </Link>
                </div>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                    ...
                    >
                        <div class="relative">
                            ...
                            <div class="absolute bottom-3 left-3 bg-purple-600 text-white text-xs px-2 py-1 rounded">
                        ...
                        <div class="pt-4 border-t border-gray-100 dark:border-gray-700">
                          ...
                          >
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-medium text-purple-600 dark:text-purple-400">#{{ learningStats.rank }} از {{ totalUsers }}</span>
                            </div>
                          </a>
                        </div>
                    </div>
