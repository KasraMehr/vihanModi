  ...
  <div class="min-h-screen flex flex-col">
    ...
    <div class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-white/30 dark:border-gray-700/30 p-4 shadow-sm">
      <div class="container mx-auto flex justify-between items-center">
        <h1 class="text-2xl font-bold text-purple-600">{{ quiz.title }}</h1>
    ...
    <main class="flex-1 container mx-auto p-6">
      ...
      <div v-if="!quizStarted" class="max-w-2xl mx-auto bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-soft border border-white/30 dark:border-gray-700/30 p-8 text-center">
        ...
        <button
          @click="startQuiz"
          class="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-xl shadow-lg transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
        >
          شروع آزمون
      ...
      <div v-else class="max-w-3xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          ...
          <div class="flex items-center bg-white/80 dark:bg-gray-800/50 px-4 py-2 rounded-xl shadow-soft">
            <ClockIcon class="w-5 h-5 text-purple-600 mr-2" />
        ...
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-soft border border-white/30 dark:border-gray-700/30 p-6 mb-8">
          ...
          <div class="flex justify-between items-center mb-6">
            ...
            <span class="text-xs bg-purple-600/10 text-purple-600 dark:text-purple-400 px-2 py-1 rounded">
            ...
            >
              <div class="flex items-center">
                <div class="flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all"
                  :class="{
                    'border-purple-600 bg-purple-600 text-white': selectedAnswer === option,
          ...
          <div v-else-if="currentQuestion.question_type === 'true_false'" class="grid grid-cols-2 gap-4">
            ...
            <div
              ...
              :class="{
                'bg-purple-600/10 border-purple-600/30': selectedAnswer === false,
                'bg-white/50 dark:bg-gray-700/50': selectedAnswer !== false
              }"
            >
              <div class="flex items-center justify-center">
                <XCircleIcon class="w-5 h-5 mr-2" :class="selectedAnswer === false ? 'text-purple-600' : 'text-gray-500 dark:text-gray-400'" />
          ...
          <div v-else-if="currentQuestion.question_type === 'fill_blank' || currentQuestion.question_type === 'text'" class="mt-4">
            <textarea
              v-model="shortAnswer"
              class="w-full p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/80 dark:bg-gray-700/80 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              rows="3"
        ...
        <div class="flex justify-between">
          ...
          <button
            @click="nextQuestion"
            class="flex items-center px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl shadow-lg transition-all transform hover:scale-105"
        ...
        <div v-if="quizCompleted" class="fixed inset-0 z-50 max-w-2xl mx-auto bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-soft border border-white/30 dark:border-gray-700/30 p-8 text-center">
            ...
            <div class="relative z-50 mb-8">
                <div class="w-24 h-24 mx-auto mb-6 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center">
                    ...
                    <XCircleIcon class="w-12 h-12 text-purple-600 dark:text-purple-400" v-else />
                </div>
            ...
            <button
                @click="resetQuiz"
                class="relative z-50 bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-xl shadow-lg transition-all transform hover:scale-105"
            >
                آزمون جدید
            </button>
        </div>
