  ...
  <StudentLayout :title="'آزمون‌های زبان'">
    <div class="container mx-auto px-4 py-8 relative z-10">
      ...
      <div class="mb-12 text-center">
        <h1 class="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-purple-400 mb-2 animate-gradient">
          آزمون‌های زبان
        </h1>
      ...
      <div class="flex flex-wrap justify-center gap-2 mb-10">
        <button
          ...
          :class="{
            'bg-gradient-to-r from-purple-500 to-blue-500 text-white shadow-lg shadow-purple-500/30': activeTab === tab.id,
      ...
      <div class="max-w-2xl mx-auto mb-12 relative">
        <div class="relative">
          <input
            ...
            class="w-full px-5 py-3.5 rounded-xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 focus:border-purple-500 focus:ring-4 focus:ring-purple-500/20 text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-300 shadow-sm hover:shadow-md"
          />
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          v-for="quiz in filtepurpleQuizzes"
          :key="quiz.id"
        ...
        >
          ...
          <div class="absolute -right-1 top-4 px-3 py-1 text-xs font-bold text-white shadow-md"
            :class="{
              ...
              'bg-purple-500': quiz.status === 'active',
          ...
          <div class="p-6">
            ...
            <div class="w-16 h-16 mb-4 rounded-xl bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 flex items-center justify-center text-purple-500 dark:text-blue-400 shadow-inner">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>

            <h2 class="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-purple-500 dark:group-hover:text-blue-400 transition-colors">{{ quiz.title }}</h2>
            ...
            <div class="space-y-3 mb-6">
              <div class="flex items-center text-gray-600 dark:text-gray-400">
                <div class="w-6 h-6 mr-2 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center text-purple-500 dark:text-purple-400">
              ...
              <div class="flex items-center text-gray-600 dark:text-gray-400">
                <div class="w-6 h-6 mr-2 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center text-blue-500 dark:text-blue-400">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              ...
              :class="{
                'bg-gradient-to-r from-purple-500 to-blue-500 text-white shadow-md hover:shadow-lg': quiz.status === 'active',
            ...
            >
              ...
              <span v-if="quiz.status === 'active'" class="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
            </button>
          </div>
        </div>
      </div>
...
const filtepurpleQuizzes = computed(() => {
